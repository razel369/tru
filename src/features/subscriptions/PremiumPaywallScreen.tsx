...
const styles = StyleSheet.create({
  ...
  benefits: { gap: 13, marginTop: 20, maxWidth: 560, width: "100%" },
  ...
  cta: { alignItems: "center", backgroundColor: colors.sage, borderRadius: 19, flexDirection: "row", gap: 8, justifyContent: "center", marginTop: 14, maxWidth: 560, minHeight: 56, width: "100%", ...shadow.card },
  ctaText: { color: colors.white, fontFamily: "Nunito_800ExtraBold", fontSize: 15 },
  disabled: { opacity: 0.58 },
  disclosure: { color: colors.muted, fontFamily: "Nunito_600SemiBold", fontSize: 9.5, lineHeight: 14, marginHorizontal: 8, marginTop: 10, maxWidth: 520, textAlign: "center" },
  ...
  footerLinks: { alignItems: "center", flexDirection: "row", justifyContent: "center", marginTop: 4, maxWidth: 560, width: "100%" },
  hero: { alignItems: "center", height: 190, justifyContent: "flex-end", marginTop: 4, maxWidth: 560, overflow: "hidden", position: "relative", width: "100%" },
  heroGlow: { backgroundColor: "rgba(255,255,255,0.55)", borderRadius: 120, height: 230, position: "absolute", top: 2, width: 230 },
  message: { alignItems: "flex-start", backgroundColor: colors.skySoft, borderRadius: 15, flexDirection: "row", gap: 8, marginTop: 12, maxWidth: 560, padding: 11, width: "100%" },
  ...
  plans: { gap: 9, marginTop: 19, maxWidth: 560, width: "100%" },
  ...
  timeline: { backgroundColor: "rgba(255,255,255,0.72)", borderRadius: 18, marginTop: 12, maxWidth: 560, paddingHorizontal: 13, paddingVertical: 12, width: "100%" },
  ...
  topBar: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", maxWidth: 560, width: "100%" },
